  ...
  <div class="card-body">
    ...
    <button type="button"  id="btn_show_send-{{$solicitud->id}}"
      ...
      ARCHIVAR
        ...
        <button type="button"  id="btn_show_send2-{{$solicitud->id}}"
...
@if ($solicitud->categoria->id== 1 || $solicitud->categoria->id == 2)
<div class="card">
  <div class="card-header">
    <h3 class="card-title">
      <i class="fas fa-text-width"></i>
  ...
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-hover table-sm mejoratb">
          ...
          <tbody>
              @foreach ($solicitud->anexos as $a)
               <tr>
                  <td class="text-center">{{$loop->iteration}}</td>
                  <td >{{ $a->documento->tipo_documento }}</td>
                  <td >
                    <a class="btn btn-info btn-sm" target="_blank" href="{{asset('documentos/solicitudes/')}}/{{$solicitud->id.'/'.$solicitud->archivo}}">
